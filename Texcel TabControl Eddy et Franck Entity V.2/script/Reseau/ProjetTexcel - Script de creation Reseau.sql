...
IF EXISTS (SELECT * FROM sysdatabases WHERE name = 'BdTexcel_Eddy_Franck')
DROP DATABASE BdTexcel_Eddy_Franck

GO
CREATE DATABASE BdTexcel_Eddy_Franck
GO
/*
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblJeu
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblClassification
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblClassificationJeu
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblGenre
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblGenreJeu
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblTheme
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblThemeJeu
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblPlateforme
(
		...
		codeSE int NOT NULL,
		tagPlateforme varchar(400) NULL,		
)
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblTypePlateforme
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblPlateformeJeu
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblSE
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblProjetTest
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblTest
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblCategorie
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblEquipe
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblEquipeEmploye
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblEmploye
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblGerant
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblAdministrateur
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblDirecteur
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblVille
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblCategorieEmploi
(
...
GO
CREATE TABLE BdTexcel_Eddy_Franck.DBO.tblCategorieEmploiEmploye
(
		idEmploye int NOT NULL,

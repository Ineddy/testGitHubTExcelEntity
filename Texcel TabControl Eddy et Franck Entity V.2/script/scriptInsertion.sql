...
('Windows','famille','8'),
('Windows','famille','7'),
('Playstation','standard','4'),
('Playstation','standard','3'),
...
('PS4',	'16Go mémoire',2,10),
('PS3',	'20Go mémoire',2,11),
('RazerBlade',	'Carte graphique Geforce',1,12),
('XboxOne',	'20Go mémoire',2,8),--une Xbox tourne avec windows
('HP Spectre','SSD, 16 Go Ram',1,12),
('Dell latitude','HDD, 8 Go Ram',1,12);
